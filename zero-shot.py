...
# print(len(all_embeddings[0*questions_per_course:(0+1)*questions_per_course]))
# print(get_most_similar(all_embeddings[0*questions_per_course:(0+1)*questions_per_course], 0))
...
embeddings = all_embeddings[0*questions_per_course:(0+1)*questions_per_course]
